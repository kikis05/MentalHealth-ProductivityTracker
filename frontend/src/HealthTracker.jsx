  ...
  return (
    <div className="main">
      <div className="content-container">
        <p className="labels">
          <strong>{displayMode ? timeIn : dateFormatted}</strong>
        </p>
        ...
        <div className="button-selector">
          {numbers.map((val) => (
            <button
              className={
                val === mood ? "button-selection-selected" : "button-selection"
              }
              key={val}
              onClick={(e) => setMood(val)}
        ...
        />
        {!displayMode && (
          <button className="submit-button" onClick={(e) => onSubmit(e)}>
            Submit
          </button>
        )}
      </div>
